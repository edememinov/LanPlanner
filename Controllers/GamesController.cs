...
namespace PlannerLanParty.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GameID,GameName,GameType")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GameID,GameName,GameType")] Game game)
        {
            if (id != game.GameID)
            {
                return NotFound();
